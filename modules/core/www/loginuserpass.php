...
use SimpleSAML\Module\opensocial\Auth\Source\OpenSocial;
...
if (array_key_exists('linkedin', $_REQUEST)) {
	sspmod_opensocial_Auth_Source_OpenSocial::delegateAuthentication('linkedin', $state);
}

if (array_key_exists('facebook', $_REQUEST)) {
	sspmod_opensocial_Auth_Source_OpenSocial::delegateAuthentication('facebook', $state);
}

if (array_key_exists('google', $_REQUEST)) {
	sspmod_opensocial_Auth_Source_OpenSocial::delegateAuthentication('google', $state);
}

if (array_key_exists('github', $_REQUEST)) {
	sspmod_opensocial_Auth_Source_OpenSocial::delegateAuthentication('github', $state);
}

if (array_key_exists('twitter', $_REQUEST)) {
	sspmod_opensocial_Auth_Source_OpenSocial::delegateAuthentication('twitter', $state);
}

if (array_key_exists('slack', $_REQUEST)) {
	sspmod_opensocial_Auth_Source_OpenSocial::delegateAuthentication('slack', $state);
}
