...
class sspmod_opensocial_Auth_Source_OpenSocial extends SimpleSAML_Auth_Source {
	 ...
	 */
	const AUTHID = 'sspmod_opensocial_Auth_Source_OpenSocial.AuthId';

	/**
	 * The string used to identify our states.
	 */
	const STAGEID = 'sspmod_opensocial_Auth_Source_OpenSocial.StageId';

	/**
	 * The key where the sources is saved in the state.
	 */
	const SOURCESID = 'sspmod_opensocial_Auth_Source_OpenSocial.SourceId';

	/**
	 * The key where the selected source is saved in the session.
	 */
	const SESSION_SOURCE = 'opensocial:selectedSource';
	...
	public function authenticate(&$state) {
		...
		$url = SimpleSAML\Module::getModuleURL('opensocial/client.php');
	...
	*/
	public function setPreviousSource($source) {
		...
		$cookieName = 'opensocial_source_' . $this->authId;
