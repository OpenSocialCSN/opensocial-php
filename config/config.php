...
$config = [
    ...
    'technicalcontact_email' => 'udraz@lablynx.com',
     ...
     */
    'secretsalt' => 'txjueumsdzkmt8jdehv4hflu24atfnh8',
     ...
     */
    'auth.adminpassword' => '2400@LabLynx',
    ...
    */
     ...
     *
     * - 'memcache': Limited datastore, which uses the PHP session.
     * - 'memcache': Key-value datastore, based on memcache.
     * - 'sql': SQL datastore, using PDO.
     * - 'redis': Key-value datastore, based on redis.
     *
     * The default datastore is 'memcache'.
     */
    'store.type'                    => 'memcache',
